...
<div class="signin-form">
  ...
  <div class="inputform-signup">
   <form action="general/signup_user.php" method="POST" autocomplete="off">
       <div class="form-header">
           <h1>sign up</h1>
           <p class="small">Are you alreadey have an account?<a href="signin.php">Sign in</a></p>
       </div>
       ...
       <div class="form-group pass-up">
            <i class="fas fa-lock icon"></i>
           <input type="password" class="form-control" name="password" placeholder="Enter Your Password" required>
       </div>
       
           <button class="butn" type="submit"  name="signup">
             sign up  
           </button>
